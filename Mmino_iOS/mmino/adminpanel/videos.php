	...
	if(isset($_POST["update_videos"])){
            if(isset($_POST["title"])){
                ...
                if(isset($_POST["visible"])){
                    $updateVideos = $db->updateAllVideos($thumbnail, $title, $artist, $desc, $video, $year, 'y', $id);
                    $message = $title." - Updated successfully";
                }else{
                    $updateVideos = $db->updateAllVideos($thumbnail, $title, $artist, $desc, $video, $year, 'n', $id);
                    $message = $title." - Updated successfully";
                }
            }
	}
                        ...
                        <li>
                            <form id="<?php echo $row["id"] ?>" class="stdform" name="" method="post">
                                ...
                                <p>
                                    ...
                                    <span class="field"><input type="text" name="video" class="input-small" value="<?php echo $row["VIDEO"] ?>" /></span>
                                </p>
                                <p>
                                ...
                                <p class="stdformbutton">
                                    <button name="update_videos" class="btn btn-primary">Update Videos</button>
